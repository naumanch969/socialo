...
import {
  ...
  Dashboard, Notes, Activity, Tasks, Document, Calender, Calculator, Kanban, Code,Tracker
} from "./App/pages"
  ...
  return (
    <div className="w-screen min-h-screen overflow-x-hidden flex bg-purple-100   " >
      <Routes>
        ...
        <Route path="/app/Code" element={<AppPageWrapper Component={Code} />} />
        ...
        <Route path={`/app/dashboard/Tracker`} element={<DashboardWrapper Component={Tracker} />} />
