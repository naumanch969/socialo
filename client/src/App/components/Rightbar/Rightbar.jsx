...
const Rightbar = () => {
    ...
    ////////////////////////////////////////// Actual Component ///////////////////////////////////////////////////
    return (
        <div className="thinScrollbar w-full h-full p-[4px] pt-0 overflow-scroll " >
            ...
            <div className="sticky top-0 bg-inherit " >
                ...
                <h3 className="text-[24px] font-medium text-text-purple-100 h-[48px] flex justify-between items-center  " >In This Page</h3>

                <div className="relative  py-[5px] " >
                    <input className="w-full h-[2rem] rounded-[10px] p-[5px] border-[1px] border-gray-400 text-text-purple-100 pr-[22px] " value={searchInput} onChange={handleChange} placeholder="search" />
                    <Cancel
                ...
                <div className="" >
                    <p className="text-[20px] font-medium text-text-purple-200 pb-[5px] " >No. of posts: <span>{codeState.codesLength}</span>  </p>
                </div>
            </div>
            ...
            <div className="flex flex-col items-start  " >
                {
                    codeState?.codesArr?.slice(startingPoint, endPoint)?.map((code, index) => (
                        <Link
                            ...
                            offset={-100}
                            duration={300}
                            className="flex items-center gap-[5px] hover:text-purple-900 cursor-pointer "
                        >
                            <p >{index + 1}.</p>
